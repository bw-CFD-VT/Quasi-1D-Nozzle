...
//---------------------------------------- V -> U -----------------------------------------------------------------------//
void primative_to_conserved (vector<vector<vector<double>>> V, vector<vector<vector<double>>> &U)
{
    U.resize(V.size());
...
//---------------------------------------- U -> V -----------------------------------------------------------------------//
void conserved_to_primative (vector<vector<vector<double>>> U, vector<vector<vector<double>>> &V)
{
    V.resize(U.size());
